...
```{r,warning=FALSE, message=FALSE}
xyplot(y.mosq ~ as.factor(Treatment), data=mosquito, type=c("p","a"), main="Human Mosquito Contact Based on Type of Material", xlab ="Treatment", ylab = "Amount of Mosquito Human Contact")
```
