...
* The **observed values** on the left show that there are 24 distinct observations, represented by the 24 cells - one for each of the observed values.
...
<center>
<img src="./images/wooden_blocks_in_box.jpg" width = 150px;>
...
Another approach to finding the degrees of freedom is to identify how many unique pieces of information the treatment effects really contain. Since all observations from the same treatment will have the same treatment effect applied, we really only need to know 4 pieces of information: the effect of each treatment. But the answer is actually less than that. Because we know that the effects must all sum to zero, only 3 of the effects are free to vary and the 4th one is constrained to be whatever value will satisfy this mathematical condition. Thus, the degrees of freedom is 3. As soon as we know 3 of the treatment effects, we can fill in the treatment effects for all the observations.
...
Being in the control group has the effect of *reducing* the difference between the pre-test and post-test score by 1.8358 on average compared to the overall, or grand, mean. In a similar way you can find the effect for Monitor/Keyboard 7.8492 - 6.5846 = 1.2645. This means the difference between the pre-test and post-test scores increased by 1.2645 on average compared to the overall mean. Presumably this is a good thing, it means this treatment was effective at boosting post-test scores. For Head Monitor Display/Joypad, the effect is -0.0058 (6.5789 -6.5846).  For Head Monitor Display/Wearables, the effect is 0.5770 (7.1616 -6.5846) (see below).
...
The value for the top left cell in residual errors factor is -0.1875. This means the observed value of 4.5614 was lower than we would have expected it to be. In other words, the observed value of 4.5614 was -0.1875 less than the average for all observations in the control group. In context of the this study, this individual's post-test score improvement was even lower than his/her peers who received the same type of training.  
